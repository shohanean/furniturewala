...
<!-- Mirrored from risingtheme.com/html/demo-furea/furea/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Feb 2026 10:04:41 GMT -->
                        ...
                        <ul class="d-flex align-items-center">
                            ...
                            <li class="language__currency--list">
                                <a class="language__switcher text-white" href="#">
                                    <img class="language__switcher--icon__img" src="{{ asset('frontend_assets') }}/img/icon/language-icon.webp"
                                        alt="currency">
                                    <span>Language</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="11.797" height="9.05"
                                        viewBox="0 0 9.797 6.05">
                ...
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <a class="main__logo--link" href="index.html"><img class="main__logo--img"
                                src="{{ asset('frontend_assets') }}/img/logo/nav-log.webp" alt="logo-img"></a>
                    </div>
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="index.html">
                        <img src="{{ asset('frontend_assets') }}/img/logo/nav-log.webp" alt="Furea Logo">
                    </a>
                            ...
                            <li class="language__currency--list">
                                <a class="offcanvas__language--switcher" href="#">
                                    <img class="language__switcher--icon__img"
                                        src="{{ asset('frontend_assets') }}/img/icon/language-icon.webp" alt="currency">
                                    <span>English</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="11.797" height="9.05"
                                        viewBox="0 0 9.797 6.05">
                                        <path d="M14.646,8.59,10.9,12.329,7.151,8.59,6,9.741l4.9,4.9,4.9-4.9Z"
            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumbnail">
                        <a href="product-details.html"><img src="{{ asset('frontend_assets') }}/img/product/product1.webp"
                                alt="prduct-img"></a>
                    </div>
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumbnail">
                        <a href="product-details.html"><img src="{{ asset('frontend_assets') }}/img/product/product2.webp"
                                alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
                    ...
                    <div class="col">
                        <div class="breadcrumb__content">
                            ...
                            <ul class="breadcrumb__content--menu d-flex">
                                ...
                                <li class="breadcrumb__content--menu__items"><span class="text-white">Contact
                                        Us</span></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="contact__info--items">
                                    ...
                                    <div class="contact__info--items__inner d-flex">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact__info--content__desc text-white">Change the design
        ...
        <section class="newsletter__banner--section section--padding pt-0">
            <div class="container">
                <div class="newsletter__banner--thumbnail position__relative">
                    <img class="newsletter__banner--thumbnail__img" src="{{ asset('frontend_assets') }}/img/banner/banner-bg7.webp"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer__widget">
                            ...
                            <div class="footer__widget--inner">
                                <a class="footer__logo" href="index.html"><img src="{{ asset('frontend_assets') }}/img/logo/nav-log.webp"
                                        alt="footer-logo"></a>
                                <p class="footer__widget--desc">Ut enim ad minim veniam, quis <br> nostrud exercitation
                                    ullamco laboris <br> nisi ut aliquip ex ea commodo.</p>
            ...
            <div class="footer__bottom d-flex justify-content-between align-items-center">
                ...
                <div class="footer__payment text-right">
                    <img class="footer__payment--visa__card display-block"
                        src="{{ asset('frontend_assets') }}/img/other/payment-visa-card.webp" alt="visa-card">
                </div>
            </div>
        </div>
    </footer>
