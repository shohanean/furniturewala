...
<!-- Mirrored from risingtheme.com/html/demo-furea/furea/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Feb 2026 10:04:06 GMT -->
<head>
  <meta charset="utf-8">
...
<body>
                        ...
                        <ul class="d-flex align-items-center">
                            <li class="language__currency--list">
                                <a class="account__currency--link style2" href="#">
                                    <img src="{{ asset('frontend_assets') }}/img/icon/usd-icon.webp" alt="currency">
                                    <span>Currency</span>
                            ...
                            <li class="language__currency--list">
                                <a class="language__switcher style2" href="#">
                                    <img class="language__switcher--icon__img" src="{{ asset('frontend_assets') }}/img/icon/language-icon.webp" alt="currency">
                                    <span>English</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="11.797" height="9.05" viewBox="0 0 9.797 6.05">
                                        <path  d="M14.646,8.59,10.9,12.329,7.151,8.59,6,9.741l4.9,4.9,4.9-4.9Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7"/>
                                    </svg>
            ...
            <div class="container">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.html"><img class="main__logo--img" src="{{ asset('frontend_assets') }}/img/logo/nav-log3.webp" alt="logo-img"></a></h1>
                    </div>
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="index.html">
                        <img src="{{ asset('frontend_assets') }}/img/logo/nav-log3.webp" alt="Furea Logo">
                    </a>
            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumbnail">
                        <a href="product-details.html"><img src="{{ asset('frontend_assets') }}/img/product/product1.webp" alt="prduct-img"></a>
                    </div>
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumbnail">
                        <a href="product-details.html"><img src="{{ asset('frontend_assets') }}/img/product/product2.webp" alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
                ...
                <div class="categories__section--inner">
                    <div class="row row-cols-lg-6 row-cols-md-4 row-cols-sm-3 row-cols-2  mb--n30">
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('frontend_assets') }}/img/product/categories-product1.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('frontend_assets') }}/img/product/categories-product2.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('frontend_assets') }}/img/product/categories-product3.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('frontend_assets') }}/img/product/categories-product4.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('frontend_assets') }}/img/product/categories-product5.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('frontend_assets') }}/img/product/categories-product6.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('frontend_assets') }}/img/product/categories-product7.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('frontend_assets') }}/img/product/categories-product8.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('frontend_assets') }}/img/product/categories-product9.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('frontend_assets') }}/img/product/categories-product10.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('frontend_assets') }}/img/product/categories-product11.webp" alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block" src="{{ asset('frontend_assets') }}/img/product/categories-product12.webp" alt="categories-product">
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img" src="{{ asset('frontend_assets') }}/img/product/product1.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('frontend_assets') }}/img/product/product2.webp" alt="product-img">
                                    </a>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img" src="{{ asset('frontend_assets') }}/img/product/product4.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('frontend_assets') }}/img/product/product3.webp" alt="product-img">
                                    </a>
                                    <ul class="product__items--action d-flex justify-content-center">
                                        <li class="product__items--action__list">
                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img" src="{{ asset('frontend_assets') }}/img/product/product5.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('frontend_assets') }}/img/product/product6.webp" alt="product-img">
                                    </a>
                                    <div class="product__badge style3">
                                        <span class="product__badge--items style3 sale">New</span>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img" src="{{ asset('frontend_assets') }}/img/product/product7.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('frontend_assets') }}/img/product/product8.webp" alt="product-img">
                                    </a>
                                    <ul class="product__items--action d-flex justify-content-center">
                                        <li class="product__items--action__list">
                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img" src="{{ asset('frontend_assets') }}/img/product/product9.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('frontend_assets') }}/img/product/product10.webp" alt="product-img">
                                    </a>
                                    <div class="product__badge style3">
                                        <span class="product__badge--items style3 sale">New</span>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img" src="{{ asset('frontend_assets') }}/img/product/product11.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('frontend_assets') }}/img/product/product12.webp" alt="product-img">
                                    </a>
                                    <ul class="product__items--action d-flex justify-content-center">
                                        <li class="product__items--action__list">
                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-7">
                        <div class="choiceus__banner position__relative d-flex">
                            <a class="choiceus__banner--thumbnail one display-block" href="shop.html" rel="nofollow"><img class="choiceus__banner--thumbnail__img display-block" src="{{ asset('frontend_assets') }}/img/banner/banner23.webp" alt="banner-img"></a>
                            <a class="choiceus__banner--thumbnail two display-block" href="shop.html" rel="nofollow"><img class="choiceus__banner--thumbnail__img two display-block" src="{{ asset('frontend_assets') }}/img/banner/banner24.webp" alt="banner-img"></a>
                    ...
                    <div class="row row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
                        ...
                        <div class="col mb-30">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img" src="{{ asset('frontend_assets') }}/img/product/product13.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('frontend_assets') }}/img/product/product14.webp" alt="product-img">
                                    </a>
                                    <div class="product__badge style3">
                                        <span class="product__badge--items style3 sale">New</span>
                                    </div>
                        ...
                        <div class="col mb-30">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img" src="{{ asset('frontend_assets') }}/img/product/product15.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('frontend_assets') }}/img/product/product1.webp" alt="product-img">
                                    </a>
                                    <ul class="product__items--action d-flex justify-content-center">
                                        <li class="product__items--action__list">
                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                        ...
                        <div class="col mb-30">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img" src="{{ asset('frontend_assets') }}/img/product/product14.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('frontend_assets') }}/img/product/product2.webp" alt="product-img">
                                    </a>
                                    <div class="product__badge style3">
                                        <span class="product__badge--items style3 sale">New</span>
                        ...
                        <div class="col mb-30">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img" src="{{ asset('frontend_assets') }}/img/product/product6.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('frontend_assets') }}/img/product/product5.webp" alt="product-img">
                                    </a>
                                    <div class="product__badge style3">
                                        <span class="product__badge--items style3 sale">New</span>
                                    </div>
                        ...
                        <div class="col mb-30">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img" src="{{ asset('frontend_assets') }}/img/product/product3.webp" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="{{ asset('frontend_assets') }}/img/product/product4.webp" alt="product-img">
                                    </a>
                                    <ul class="product__items--action d-flex justify-content-center">
                                        <li class="product__items--action__list">
                                            <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                ...
                <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n28">
                    <div class="col mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html"><img class="banner__items--thumbnail__img" src="{{ asset('frontend_assets') }}/img/banner/banner20.webp" alt="banner-img">
        ...
        <div class="deals__banner--section color-scheme-3 section--padding pt-0">
            <div class="container">
                <div class="deals__banner--thumbnail mt-0">
                    <a class="deals__banner--thumbnail__link display-block position__relative" href="shop.html"><img class="deals__banner--thumbnail__img style2 display-block" src="{{ asset('frontend_assets') }}/img/banner/banner-bg5.webp" alt="deals-thumbnail-img ">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="product__items new__product--items border">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img" src="{{ asset('frontend_assets') }}/img/product/product16.webp" alt="product-img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="product__items new__product--items border">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img" src="{{ asset('frontend_assets') }}/img/product/product17.webp" alt="product-img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="product__items new__product--items border">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img" src="{{ asset('frontend_assets') }}/img/product/product18.webp" alt="product-img">
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="newsletter__banner--section section--padding color-scheme-3">
            <div class="container">
                <div class="newsletter__banner--thumbnail position__relative">
                    <img class="newsletter__banner--thumbnail__img" src="{{ asset('frontend_assets') }}/img/banner/banner-bg6.webp" alt="newsletter-banner">
                                ...
                                <div class="swiper-wrapper">
                                        ...
                                        <div class="testimonial__items--style3 border-radius-5">
                                            <div class="testimonial__style3--topbar text-center">
                                                <div class="testimonial__thumbnail--style3">
                                                    <img class="testimonial__thumbnail--style3__img display-block" src="{{ asset('frontend_assets') }}/img/other/testimonial-thumb4.webp" alt="testimonial-img">
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial__items--style3 border-radius-5">
                                            <div class="testimonial__style3--topbar text-center">
                                                <div class="testimonial__thumbnail--style3">
                                                    <img class="testimonial__thumbnail--style3__img display-block" src="{{ asset('frontend_assets') }}/img/other/testimonial-thumb5.webp" alt="testimonial-img">
                                                </div>
                                                <div class="testimonial__style3--author">
                                                    <h3 class="testimonial__style3--author__title h4">Robert Bruze</h3>
                                                    <h4 class="testimonial__style3--author__subtitle h5">Product Designer</h4>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial__items--style3 border-radius-5">
                                            <div class="testimonial__style3--topbar text-center">
                                                <div class="testimonial__thumbnail--style3">
                                                    <img class="testimonial__thumbnail--style3__img display-block" src="{{ asset('frontend_assets') }}/img/other/testimonial-thumb6.webp" alt="testimonial-img">
                                                </div>
                                                <div class="testimonial__style3--author">
                                                    <h3 class="testimonial__style3--author__title h4">Robert Bruze</h3>
                                                    <h4 class="testimonial__style3--author__subtitle h5">Product Designer</h4>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial__items--style3 border-radius-5">
                                            <div class="testimonial__style3--topbar text-center">
                                                <div class="testimonial__thumbnail--style3">
                                                    <img class="testimonial__thumbnail--style3__img display-block" src="{{ asset('frontend_assets') }}/img/other/testimonial-thumb7.webp" alt="testimonial-img">
                                                </div>
                                                <div class="testimonial__style3--author">
                                                    <h3 class="testimonial__style3--author__title h4">Robert Bruze</h3>
                                                    <h4 class="testimonial__style3--author__subtitle h5">Product Designer</h4>
                ...
                <div class="blog__section--inner blog__swiper--column3 swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html"><img class="blog__thumbnail--img display-block" src="{{ asset('frontend_assets') }}/img/blog/blog1.webp" alt="blog-img"></a>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html"><img class="blog__thumbnail--img display-block" src="{{ asset('frontend_assets') }}/img/blog/blog2.webp" alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
                                        <li class="blog__content--meta__text">
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html"><img class="blog__thumbnail--img display-block" src="{{ asset('frontend_assets') }}/img/blog/blog3.webp" alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
                                        <li class="blog__content--meta__text">
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html"><img class="blog__thumbnail--img display-block" src="{{ asset('frontend_assets') }}/img/blog/blog4.webp" alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
                                        <li class="blog__content--meta__text">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkF3TLBTT7" ><img class="instagram__thumbnail--img display-block" src="{{ asset('frontend_assets') }}/img/other/instagram1.webp" alt="instagram-img">
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkF60sBxhN" ><img class="instagram__thumbnail--img display-block" src="{{ asset('frontend_assets') }}/img/other/instagram2.webp" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkF90ZB6HG" ><img class="instagram__thumbnail--img display-block" src="{{ asset('frontend_assets') }}/img/other/instagram3.webp" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkGAe6BQeu" ><img class="instagram__thumbnail--img display-block" src="{{ asset('frontend_assets') }}/img/other/instagram4.webp" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkGCWcBbv9" ><img class="instagram__thumbnail--img display-block" src="{{ asset('frontend_assets') }}/img/other/instagram5.webp" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkGFDMhoid" ><img class="instagram__thumbnail--img display-block" src="{{ asset('frontend_assets') }}/img/other/instagram6.webp" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                        ...
                        <div class="swiper-slide">
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank" href="https://www.instagram.com/p/CZkGGnyh7jZ" ><img class="instagram__thumbnail--img display-block" src="{{ asset('frontend_assets') }}/img/other/instagram7.webp" alt="instagram-img">
                                    <span class="instagram__social--icon"><svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198" height="25.199" viewBox="0 0 25.198 25.199">
                                        <defs>
                                        <radialGradient  cx="0.133" cy="1.005" r="1.305" gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                            <stop offset="0.09" stop-color="#fa8f21"/>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer__widget">
                            ...
                            <div class="footer__widget--inner">
                                <a class="footer__logo" href="index.html"><img src="{{ asset('frontend_assets') }}/img/logo/nav-log3.webp" alt="footer-logo"></a>
                        ...
                        <div class="footer__widget">
                            ...
                            <div class="footer__contact--info footer__widget--inner">
                                ...
                                <div class="footer__payment--method">
                                    ...
                                    <img class="footer__payment--visa__card display-block" src="{{ asset('frontend_assets') }}/img/other/payment-visa-card.webp" alt="visa-card">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('frontend_assets') }}/img/product/big-product1.webp"><img class="product__media--preview__items--img" src="{{ asset('frontend_assets') }}/img/product/big-product1.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{ asset('frontend_assets') }}/img/product/big-product1.webp" data-gallery="product-media-preview">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('frontend_assets') }}/img/product/big-product2.webp"><img class="product__media--preview__items--img" src="{{ asset('frontend_assets') }}/img/product/big-product2.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{ asset('frontend_assets') }}/img/product/big-product2.webp" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">Media Gallery</span>
                                                </a>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('frontend_assets') }}/img/product/big-product3.webp"><img class="product__media--preview__items--img" src="{{ asset('frontend_assets') }}/img/product/big-product3.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{ asset('frontend_assets') }}/img/product/big-product3.webp" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">Media Gallery</span>
                                                </a>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('frontend_assets') }}/img/product/big-product4.webp"><img class="product__media--preview__items--img" src="{{ asset('frontend_assets') }}/img/product/big-product4.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{ asset('frontend_assets') }}/img/product/big-product4.webp" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">Media Gallery</span>
                                                </a>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('frontend_assets') }}/img/product/big-product5.webp"><img class="product__media--preview__items--img" src="{{ asset('frontend_assets') }}/img/product/big-product5.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{ asset('frontend_assets') }}/img/product/big-product5.webp" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">Media Gallery</span>
                                                </a>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset('frontend_assets') }}/img/product/big-product6.webp"><img class="product__media--preview__items--img" src="{{ asset('frontend_assets') }}/img/product/big-product6.webp" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{ asset('frontend_assets') }}/img/product/big-product6.webp" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">Media Gallery</span>
                                                </a>
                                            </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{ asset('frontend_assets') }}/img/product/small-product1.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{ asset('frontend_assets') }}/img/product/small-product2.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{ asset('frontend_assets') }}/img/product/small-product3.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{ asset('frontend_assets') }}/img/product/small-product4.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{ asset('frontend_assets') }}/img/product/small-product5.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{ asset('frontend_assets') }}/img/product/small-product6.webp" alt="product-nav-img">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper__nav--btn swiper-button-next"></div>
                                        ...
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <div class="variant__color d-flex">
                                                <div class="variant__color--list">
                                                    ...
                                                    <label class="variant__color--value red" for="color-red1" title="Red"><img class="variant__color--value__img" src="{{ asset('frontend_assets') }}/img/product/product1.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red2" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red2" title="Black"><img class="variant__color--value__img" src="{{ asset('frontend_assets') }}/img/product/product6.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red3" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red3" title="Pink"><img class="variant__color--value__img" src="{{ asset('frontend_assets') }}/img/product/product7.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red4" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red4" title="Orange"><img class="variant__color--value__img" src="{{ asset('frontend_assets') }}/img/product/product4.webp" alt="variant-color-img"></label>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
        ...
        <div class="newsletter__popup--inner">
            ...
            <div class="box newsletter__popup--box d-flex align-items-center">
                <div class="newsletter__popup--thumbnail">
                    <img class="newsletter__popup--thumbnail__img display-block" src="{{ asset('frontend_assets') }}/img/banner/newsletter-popup-thumb.png" alt="newsletter-popup-thumb">
                </div>
  ...
  <!-- <script src="{{ asset('frontend_assets') }}/js/vendor/popper.js" defer="defer"></script> -->
  <!-- <script src="{{ asset('frontend_assets') }}/js/vendor/bootstrap.min.js" defer="defer"></script> -->

  <script src="{{ asset('frontend_assets') }}/js/plugins/swiper-bundle.min.js" defer="defer"></script>
  <script src="{{ asset('frontend_assets') }}/js/plugins/glightbox.min.js" defer="defer"></script>

  <!-- Customscript js -->
  <script src="{{ asset('frontend_assets') }}/js/script.js" defer="defer"></script>

</body>

<!-- Mirrored from risingtheme.com/html/demo-furea/furea/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Feb 2026 10:04:20 GMT -->
</html>
