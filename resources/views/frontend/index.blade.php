                            ...
                            <li class="language__currency--list">
                                <a class="language__switcher style2" href="#">
                                    <img class="language__switcher--icon__img"
                                        src="{{ asset('frontend_assets') }}/img/icon/language-icon.webp"
                                        alt="currency">
                                    <span>English</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="11.797" height="9.05"
                                        viewBox="0 0 9.797 6.05">
                ...
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.html"><img
                                    ...
                                    src="{{ asset('frontend_assets') }}/img/logo/nav-log3.webp" alt="logo-img"></a>
                        </h1>
                    </div>
                        ...
                        <nav class="header__menu--navigation style3">
                            <ul class="d-flex justify-content-center">
                                <li class="header__menu--items style3">
                                    <a class="header__menu--link style3" href="index.html">Home <span
                                ...
                                <li class="header__menu--items mega__menu--items style3">
                                    <a class="header__menu--link style3" href="shop.html">Shop <span
                                            class="menu__plus--icon">+</span></a>
                                ...
                                <li class="header__menu--items style3">
                                    <a class="header__menu--link style3" href="blog.html">Blog <span
                                            class="menu__plus--icon">+</span> </a>
                                    <ul class="header__sub--menu">
                                ...
                                <li class="header__menu--items style3">
                                    <a class="header__menu--link style3" href="#">Pages <span
                                            class="menu__plus--icon">+</span></a>
                                    <ul class="header__sub--menu">
                                ...
                                <li class="header__menu--items style3">
                                    <a class="header__menu--link style3" href="{{ route('contact') }}">Contact </a>
                                </li>
                            </ul>
                        </nav>
                    </div>
        ...
        <div class="offCanvas__minicart color-scheme-3" tabindex="-1">
            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumbnail">
                        <a href="product-details.html"><img
                                src="{{ asset('frontend_assets') }}/img/product/product1.webp" alt="prduct-img"></a>
                    </div>
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumbnail">
                        <a href="product-details.html"><img
                                src="{{ asset('frontend_assets') }}/img/product/product2.webp" alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
                    ...
                    <div class="row row-cols-lg-6 row-cols-md-4 row-cols-sm-3 row-cols-2  mb--n30">
                            ...
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('frontend_assets') }}/img/product/categories-product1.webp"
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('frontend_assets') }}/img/product/categories-product2.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('frontend_assets') }}/img/product/categories-product3.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('frontend_assets') }}/img/product/categories-product4.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('frontend_assets') }}/img/product/categories-product5.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('frontend_assets') }}/img/product/categories-product6.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('frontend_assets') }}/img/product/categories-product7.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('frontend_assets') }}/img/product/categories-product8.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('frontend_assets') }}/img/product/categories-product9.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('frontend_assets') }}/img/product/categories-product10.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('frontend_assets') }}/img/product/categories-product11.webp"
                                        alt="categories-product">
                        ...
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="shop.html">
                                    <img class="categories__product--thumbnail__img display-block"
                                        src="{{ asset('frontend_assets') }}/img/product/categories-product12.webp"
                                        alt="categories-product">
                                ...
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product1.webp"
                                            alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product2.webp"
                                            alt="product-img">
                                    </a>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product4.webp"
                                            alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product3.webp"
                                            alt="product-img">
                                    </a>
                                    <ul class="product__items--action d-flex justify-content-center">
                                        <li class="product__items--action__list">
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product5.webp"
                                            alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product6.webp"
                                            alt="product-img">
                                    </a>
                                    <div class="product__badge style3">
                                        <span class="product__badge--items style3 sale">New</span>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product7.webp"
                                            alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product8.webp"
                                            alt="product-img">
                                    </a>
                                    <ul class="product__items--action d-flex justify-content-center">
                                        <li class="product__items--action__list">
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product9.webp"
                                            alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product10.webp"
                                            alt="product-img">
                                    </a>
                                    <div class="product__badge style3">
                                        <span class="product__badge--items style3 sale">New</span>
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product11.webp"
                                            alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product12.webp"
                                            alt="product-img">
                                    </a>
                                    <ul class="product__items--action d-flex justify-content-center">
                                        <li class="product__items--action__list">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-7">
                        <div class="choiceus__banner position__relative d-flex">
                            <a class="choiceus__banner--thumbnail one display-block" href="shop.html"
                                rel="nofollow"><img class="choiceus__banner--thumbnail__img display-block"
                                    src="{{ asset('frontend_assets') }}/img/banner/banner23.webp"
                                    alt="banner-img"></a>
                            <a class="choiceus__banner--thumbnail two display-block" href="shop.html"
                                rel="nofollow"><img class="choiceus__banner--thumbnail__img two display-block"
                                    src="{{ asset('frontend_assets') }}/img/banner/banner24.webp"
                                    alt="banner-img"></a>
                            <div class="bideo__play style3">
                                <a class="bideo__play--icon style3 glightbox" href="https://vimeo.com/115041822"
                                    data-gallery="video">
                            ...
                            <div class="choiceus__info">
                                <div class="choiceus__info--step d-flex">
                                    <div class="choiceus__info--list">
                                        <svg class="choiceus__info--icon" data-name="Group 118"
                                                ...
                                                <g id="Group_124" data-name="Group 124"
                                                    ...
                                                    <g id="Group_123" data-name="Group 123"
                                                        ...
                                                        <path id="Path_105" data-name="Path 105"
                                                            ...
                                                            transform="translate(0 -59.798)" fill="#121a25" />
                                                    </g>
                                                </g>
                                                ...
                                                <g id="Group_130" data-name="Group 130"
                                                    ...
                                                    <g id="Group_129" data-name="Group 129">
                                                        <path id="Path_108" data-name="Path 108"
                                                            ...
                                                            transform="translate(-396.97 -378.2)" fill="#121a25" />
                                                    </g>
                                                </g>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="35.354" height="41.512"
                                            ...
                                            <g id="refund" transform="translate(-37.974)">
                                                <path id="Path_100" data-name="Path 100"
                                                    ...
                                                    transform="translate(-106.693 -150.428)" fill="#121a25" />
                                                <path id="Path_101" data-name="Path 101"
                                                    ...
                                                    transform="translate(-72.633 -114.413)" fill="#121a25" />
                                                <path id="Path_102" data-name="Path 102"
                                                    ...
                                                    transform="translate(0)" fill="#121a25" />
                                            </g>
                                        </svg>
                        ...
                        <div class="col mb-30">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product13.webp"
                                            alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product14.webp"
                                            alt="product-img">
                                    </a>
                                    <div class="product__badge style3">
                                        <span class="product__badge--items style3 sale">New</span>
                        ...
                        <div class="col mb-30">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product15.webp"
                                            alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{ asset('frontend_assets') }}/img/product/product1.webp"
                                            alt="product-img">
                    ...
                    <div class="col mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="shop.html"><img
                                    ...
                                    src="{{ asset('frontend_assets') }}/img/banner/banner20.webp" alt="banner-img">
            ...
            <div class="container">
                <div class="deals__banner--thumbnail mt-0">
                    <a class="deals__banner--thumbnail__link display-block position__relative" href="shop.html"><img
                            ...
                            src="{{ asset('frontend_assets') }}/img/banner/banner-bg5.webp"
                    ...
                    <div class="new__product--content">
                        ...
                        <div class="new__product--price">
                            ...
                            <ul class="new__product--price__inner d-flex align-items-center">
                                <li class="new__product--price__list"><span
                                        class="new__product--current__price">$25.00</span></li>
                                <li class="new__product--price__list"><span
                                        class="new__product--old__price">$30.00</span></li>
                            </ul>
                        </div>
                        <a class="new__product--content__btn primary__btn btn__style3" href="shop.html">View
                            More</a>
                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="product__items new__product--items border">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img"
                                                src="{{ asset('frontend_assets') }}/img/product/product16.webp"
                                                alt="product-img">
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="product__items new__product--items border">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img"
                                                src="{{ asset('frontend_assets') }}/img/product/product17.webp"
                                                alt="product-img">
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="product__items new__product--items border">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img"
                                                src="{{ asset('frontend_assets') }}/img/product/product18.webp"
                                                alt="product-img">
                                        </a>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="newsletter__banner--thumbnail position__relative">
                    <img class="newsletter__banner--thumbnail__img"
                        src="{{ asset('frontend_assets') }}/img/banner/banner-bg6.webp" alt="newsletter-banner">
                    <div class="newsletter__content newsletter__subscribe">
                        ...
                        <form class="newsletter__subscribe--form position__relative" action="#">
                            ...
                            <button class="newsletter__subscribe--button primary__btn btn__style3"
                                        ...
                                        <div class="testimonial__items--style3 border-radius-5">
                                            <div class="testimonial__style3--topbar text-center">
                                                <div class="testimonial__thumbnail--style3">
                                                    <img class="testimonial__thumbnail--style3__img display-block"
                                                        src="{{ asset('frontend_assets') }}/img/other/testimonial-thumb4.webp"
                                                        alt="testimonial-img">
                                                </div>
                                                <div class="testimonial__style3--author">
                                                    <h3 class="testimonial__style3--author__title h4">Robert Bruze
                                                    </h3>
                                                    <h4 class="testimonial__style3--author__subtitle h5">Product
                                                        Designer</h4>
                                                </div>
                                            </div>
                                            <div class="testimonial__style3--content">
                                                <svg class="testimonial__style3--quote__icon"
                                                    xmlns="http://www.w3.org/2000/svg" width="27"
                                                    height="20.25" viewBox="0 0 27 20.25">
                                                ...
                                                <p class="testimonial__style3--content__desc text-center">All
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial__items--style3 border-radius-5">
                                            <div class="testimonial__style3--topbar text-center">
                                                <div class="testimonial__thumbnail--style3">
                                                    <img class="testimonial__thumbnail--style3__img display-block"
                                                        src="{{ asset('frontend_assets') }}/img/other/testimonial-thumb5.webp"
                                                        alt="testimonial-img">
                                                </div>
                                                <div class="testimonial__style3--author">
                                                    <h3 class="testimonial__style3--author__title h4">Robert Bruze
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial__items--style3 border-radius-5">
                                            <div class="testimonial__style3--topbar text-center">
                                                <div class="testimonial__thumbnail--style3">
                                                    <img class="testimonial__thumbnail--style3__img display-block"
                                                        src="{{ asset('frontend_assets') }}/img/other/testimonial-thumb6.webp"
                                                        alt="testimonial-img">
                                                </div>
                                                <div class="testimonial__style3--author">
                                                    <h3 class="testimonial__style3--author__title h4">Robert Bruze
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial__items--style3 border-radius-5">
                                            <div class="testimonial__style3--topbar text-center">
                                                <div class="testimonial__thumbnail--style3">
                                                    <img class="testimonial__thumbnail--style3__img display-block"
                                                        src="{{ asset('frontend_assets') }}/img/other/testimonial-thumb7.webp"
                                                        alt="testimonial-img">
                                                </div>
                                                <div class="testimonial__style3--author">
                                                    <h3 class="testimonial__style3--author__title h4">Robert Bruze
                            ...
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html"><img
                                            ...
                                            src="{{ asset('frontend_assets') }}/img/blog/blog1.webp"
                                            alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
                                        <li class="blog__content--meta__text">
                                            <svg class="blog__content--meta__icon"
                                                xmlns="http://www.w3.org/2000/svg" width="11.001" height="11.001"
                                        ...
                                        <li class="blog__content--meta__text">
                                            <svg class="blog__content--meta__icon"
                                                xmlns="http://www.w3.org/2000/svg" width="12.569" height="13.966"
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html"><img
                                            class="blog__thumbnail--img display-block"
                                            src="{{ asset('frontend_assets') }}/img/blog/blog2.webp"
                                            alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html"><img
                                            class="blog__thumbnail--img display-block"
                                            src="{{ asset('frontend_assets') }}/img/blog/blog3.webp"
                                            alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link display-block" href="blog-details.html"><img
                                            class="blog__thumbnail--img display-block"
                                            src="{{ asset('frontend_assets') }}/img/blog/blog4.webp"
                                            alt="blog-img"></a>
                                </div>
                                <div class="blog__content text-center">
                                    <ul class="blog__content--meta d-flex justify-content-center">
                            ...
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkF3TLBTT7"><img
                                        ...
                                        src="{{ asset('frontend_assets') }}/img/other/instagram1.webp"
                                        alt="instagram-img">
                            ...
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkF60sBxhN"><img
                                        class="instagram__thumbnail--img display-block"
                                        src="{{ asset('frontend_assets') }}/img/other/instagram2.webp"
                                        alt="instagram-img">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198"
                                            height="25.199" viewBox="0 0 25.198 25.199">
                            ...
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkF90ZB6HG"><img
                                        class="instagram__thumbnail--img display-block"
                                        src="{{ asset('frontend_assets') }}/img/other/instagram3.webp"
                                        alt="instagram-img">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198"
                                            height="25.199" viewBox="0 0 25.198 25.199">
                            ...
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkGAe6BQeu"><img
                                        class="instagram__thumbnail--img display-block"
                                        src="{{ asset('frontend_assets') }}/img/other/instagram4.webp"
                                        alt="instagram-img">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198"
                                            height="25.199" viewBox="0 0 25.198 25.199">
                            ...
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkGCWcBbv9"><img
                                        class="instagram__thumbnail--img display-block"
                                        src="{{ asset('frontend_assets') }}/img/other/instagram5.webp"
                                        alt="instagram-img">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198"
                                            height="25.199" viewBox="0 0 25.198 25.199">
                            ...
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkGFDMhoid"><img
                                        class="instagram__thumbnail--img display-block"
                                        src="{{ asset('frontend_assets') }}/img/other/instagram6.webp"
                                        alt="instagram-img">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198"
                                            height="25.199" viewBox="0 0 25.198 25.199">
                            ...
                            <div class="instagram__thumbnail position__relative">
                                <a class="instagram__thumbnail--link display-block" target="_blank"
                                    href="https://www.instagram.com/p/CZkGGnyh7jZ"><img
                                        class="instagram__thumbnail--img display-block"
                                        src="{{ asset('frontend_assets') }}/img/other/instagram7.webp"
                                        alt="instagram-img">
                                    <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="25.198"
                                            height="25.199" viewBox="0 0 25.198 25.199">
                        ...
                        <div class="footer__widget">
                            ...
                            <div class="footer__widget--inner">
                                <a class="footer__logo" href="index.html"><img
                                        src="{{ asset('frontend_assets') }}/img/logo/nav-log3.webp"
                                        alt="footer-logo"></a>
                        ...
                        <div class="footer__widget">
                            ...
                            <div class="footer__contact--info footer__widget--inner">
                                <ul class="footer__contact--info__inner">
                                    <li class="footer__contact--info__text"><strong>Address:</strong> 1351 New Jercy
                                        Rd, USA 48247</li>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                ...
                                                href="{{ asset('frontend_assets') }}/img/product/big-product1.webp"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('frontend_assets') }}/img/product/big-product1.webp"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                    href="{{ asset('frontend_assets') }}/img/product/big-product1.webp"
                                                    data-gallery="product-media-preview">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                data-gallery="product-media-preview"
                                                href="{{ asset('frontend_assets') }}/img/product/big-product2.webp"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('frontend_assets') }}/img/product/big-product2.webp"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                    href="{{ asset('frontend_assets') }}/img/product/big-product2.webp"
                                                    data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg"
                                                        xmlns="http://www.w3.org/2000/svg" width="22.51"
                                                        height="22.443" viewBox="0 0 512 512">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                data-gallery="product-media-preview"
                                                href="{{ asset('frontend_assets') }}/img/product/big-product3.webp"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('frontend_assets') }}/img/product/big-product3.webp"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                    href="{{ asset('frontend_assets') }}/img/product/big-product3.webp"
                                                    data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg"
                                                        xmlns="http://www.w3.org/2000/svg" width="22.51"
                                                        height="22.443" viewBox="0 0 512 512">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                data-gallery="product-media-preview"
                                                href="{{ asset('frontend_assets') }}/img/product/big-product4.webp"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('frontend_assets') }}/img/product/big-product4.webp"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                    href="{{ asset('frontend_assets') }}/img/product/big-product4.webp"
                                                    data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg"
                                                        xmlns="http://www.w3.org/2000/svg" width="22.51"
                                                        height="22.443" viewBox="0 0 512 512">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                data-gallery="product-media-preview"
                                                href="{{ asset('frontend_assets') }}/img/product/big-product5.webp"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('frontend_assets') }}/img/product/big-product5.webp"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                    href="{{ asset('frontend_assets') }}/img/product/big-product5.webp"
                                                    data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg"
                                                        xmlns="http://www.w3.org/2000/svg" width="22.51"
                                                        height="22.443" viewBox="0 0 512 512">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                data-gallery="product-media-preview"
                                                href="{{ asset('frontend_assets') }}/img/product/big-product6.webp"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('frontend_assets') }}/img/product/big-product6.webp"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                    href="{{ asset('frontend_assets') }}/img/product/big-product6.webp"
                                                    data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg"
                                                        xmlns="http://www.w3.org/2000/svg" width="22.51"
                                                        height="22.443" viewBox="0 0 512 512">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('frontend_assets') }}/img/product/small-product1.webp"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('frontend_assets') }}/img/product/small-product2.webp"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('frontend_assets') }}/img/product/small-product3.webp"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('frontend_assets') }}/img/product/small-product4.webp"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('frontend_assets') }}/img/product/small-product5.webp"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('frontend_assets') }}/img/product/small-product6.webp"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="box newsletter__popup--box d-flex align-items-center">
                <div class="newsletter__popup--thumbnail">
                    <img class="newsletter__popup--thumbnail__img display-block"
                        src="{{ asset('frontend_assets') }}/img/banner/newsletter-popup-thumb.png"
